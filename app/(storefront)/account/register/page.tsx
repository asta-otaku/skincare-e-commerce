...
export default function AccountRegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(false)
    setError("Registration is not yet enabled. Supabase integration coming soon.")
  }
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-160px)] max-w-md flex-col items-center justify-center px-5 py-12">
                ...
                {[0, 1, 2].map((i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      i < strength
                        ? strength === 1 ? "bg-destructive" : strength === 2 ? "bg-gold" : "bg-green-500"
                        : "bg-border",
                    )}
                  />
                ))}
        ...
        <label className="flex cursor-pointer items-start gap-3 pt-1">
          <div
            ...
            className={cn(
              ...
              agreed ? "border-gold bg-gold" : "border-border",
            )}
          >
          ...
          <span className="text-xs font-light text-muted-foreground leading-relaxed">
            ...
            I consent to receiving order updates by email.
          </span>
        </label>
      ...
      <p className="mt-8 text-center text-xs font-light text-muted-foreground">
        ...
        <Link href="/account/login" className="font-medium text-foreground underline-offset-2 hover:underline">
          Sign in
        </Link>
      </p>
